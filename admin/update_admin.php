...
if(isset($_POST['update'])){
	...
	if (isset($_FILES['admin_img'])){
	     ...
	     $name           = $_FILES['admin_img']['name'];
	     $query="UPDATE `admin` SET `admin_email`='$email',`admin_password`='$admin_password',`full_name`='$full_name',`admin_image`='$name' WHERE admin_id='$admin_id'";
		...
		echo "<script type='text/javascript'>
		   ...
		   $query="UPDATE `admin` SET `admin_email`='$email',`admin_password`='$admin_password',`full_name`='$full_name' WHERE admin_id='$admin_id'";
					...
					<div class="card-body">
						<form method="post" action="">
							...
							<div class="form-group">
								...
								<img src="../images/adminProfile/<?php echo $admin_data['admin_image']; ?>" height="80" width="80">
								<input type="file" name="admin_img" class="form-control">
								<input type="hidden" name="old_image" class="form-control" value="<?php echo $admin_data['adin_images']; ?>">

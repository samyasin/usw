      ...
      $result = mysqli_query($con,$query);
       ...
       echo "<div class='row'>";
		...
		<a href='images.php?album_id={$album['album_id']}&album_name={$album['album_name']}' class='btn btn-primary'>Show</a>
				<a href='' data-toggle='modal' data-target='#myModal' class='btn btn-primary'>Delete</a>
	...
	<div class='modal-dialog modal-confirm'>
		<div class='modal-content'>
			...
			<div class='modal-footer'>
				<a href='delete_album.php?album_id={$album['album_id']}&album_name={$album['album_name']}' class='btn btn-danger btn-block'  id='ok'>Confirm</a>

...
if (isset($_POST['update'])){
	...
	$path              = "../images/emp_sign/";
		...
		$query	= "UPDATE `register` SET `stu_name`=$stu_name,`stu_name_ar`='$stu_name_ar',`stu_birth`= '$stu_birth',`stu_nat`='$stu_nat',`stu_phone`='$stu_phone',`stu_mobile`='$stu_mobile',`stu_qualifications`='$stu_qualifications',`stu_major`='$stu_major',`stu_univ`='$stu_univ',`stu_job`='$stu_job',`category_id`='$category_id',`emp_name`='$emp_name',`reg_date`='$reg_date',`stu_nat_num`='$stu_nat_num' WHERE stu_id = $stu_id";
						...
						<form method="post" action="" enctype="multipart/form-data">
							<div class="form-group">
								...
								<select name='category_id' class='form-control'>
									...
									echo "<option value='".$cat['cat_id']."'";
									 if ($cat['cat_id'] == $stu_data['category_id'])
							...
							<div class="form-group">
								<label class="form-control-label">Student Qualifications</label><br>
                                                                <input type="text" name="stu_qualifications" placeholder="stu_qualifications" class="form-control" value="<?php echo $stu_data['stu_qualifications']; ?>">
							</div>

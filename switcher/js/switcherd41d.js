        ...
        $( '.lgx-switcher-loader' ).switcher( {
            ...
            layout: [

                {
                    ...
                    link: 'http://themearth.com/demo/html/eventpoint/view/index-banner.html'
                },

                {
                    image: 'demo-contentslider.png',
                    link: 'http://themearth.com/demo/html/eventpoint/view/index-contentslider.html'
                },
                {
                    image: 'demo-typed.png',
                    link: 'http://themearth.com/demo/html/eventpoint/view/index-typed.html'
                },

                {
                    image: 'demo-slider.png',
                    link: 'http://themearth.com/demo/html/eventpoint/view/index-slider.html'
                },
                {
                    image: 'demo-blog-list.png',
                    link: 'http://themearth.com/demo/html/eventpoint/view/index-gradient.html'
                },
                {
                    image: 'demo-default.png',
                    link: 'http://themearth.com/demo/html/eventpoint/view/index.html'
                }
            ]
        } );
    } else {
